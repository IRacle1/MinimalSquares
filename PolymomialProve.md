...
*Следуя той же логике можно обобщить линейность МНК до функций типа*

$$g(x,y) = a_1 f_1(x,y) + a_2 f_2(x,y) + \dots + a_n f_n(x,y)$$

*где каждый одночлен зависит от $x$ и $y$ одновременно*
...
Гипербола такого вида может быть преобразована умножением обоих частей на $x + b$

$$(x+b)y = a$$
$$xy+by = a$$
$$xy = a - by$$

*Тут можно и закончить, потому что выражение линейно относительно $(x,y)$, но можно разделить на $y$ и получить еще более простой вид*
